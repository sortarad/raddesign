...
export default function ContactPage() {
    return (
        <div className="back-white flex flex-col pt-4">
            ...
            <p className="px-4 text-veryLarge leading-large mt-12 font-TeX-Regular">YOUNG<br/>LAB</p>
            <p className="px-4 text-3xl mt-12 font-VT323-Regular">STUDIO & GALLERY<br/>
            ...
            <div className="flex flex-row justify-between items-end mt-24 pb-6">
                <p className="pl-4 w-contactTextBox text-3xl font-TeX-Regular">YOUNG LAB is a global creative studio focused on design, development, and digital output.
