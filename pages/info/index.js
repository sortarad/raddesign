    ...
    return (
        <div className="flex flex-row w-full">
            <div className="w-infoBox flex flex-col justify-between pb-24 mt-4">
                ...
                <p className="text-2xl px-4 mt-24 font-TeX-Regular">YOUNG LAB is a global creative studio focused on design, development, and digital output.
                ...
                <p className="text-2xl px-4 font-TeX-Regular">From conception to execution, SPECIAL OFFER considers the visceral factors that contribute to the user
            ...
            <div className="w-infoBox">
                ...
                <h1 className="text-6xl pl-24 font-TeX-Regular">Work</h1>
